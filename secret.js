(function () {
    ...
    // Buffer for key sequence detection
    let buffer = [];
    ...
    window.addEventListener('keydown', (e) => {
        ...
        // More junk code to confuse readers
